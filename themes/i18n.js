...
(function(){
  const dict = {
    en: {
      ...
      "landing.opt.bpm":       "BPM",
      "landing.opt.bpm_hint":  "empty = AI decides",
      "landing.opt.style":     "STYLE",
      "landing.opt.style_hint":"empty = no constraint",
      "landing.opt.custom":           "CUSTOM RULES",
      "landing.opt.custom_placeholder":"e.g. only A:dorian / drums only / must have pad backing...",
      "landing.opt.custom_hint":      "free-form rules applied to every generation",
    ...
    zh: {
      ...
      "landing.opt.bpm":       "BPM",
      "landing.opt.bpm_hint":  "空 = AI 自定",
      "landing.opt.style":     "风格",
      "landing.opt.style_hint":"空 = 不限制",
      "landing.opt.custom":           "全局设定",
      "landing.opt.custom_placeholder":"如: 只用 A 多利亚调式 / 只允许打击乐 / 必须有 pad 铺底...",
      "landing.opt.custom_hint":      "自由文本规则, 每一次生成都遵守",
    ...
    ja: {
      ...
      "landing.opt.bpm":       "BPM",
      "landing.opt.bpm_hint":  "空 = AI が決める",
      "landing.opt.style":     "スタイル",
      "landing.opt.style_hint":"空 = 制限なし",
      "landing.opt.custom":           "カスタムルール",
      "landing.opt.custom_placeholder":"例: ドリアンスケールのみ / 打楽器のみ / パッドの厚みが必須...",
      "landing.opt.custom_hint":      "自由形式のルール, 全ての生成に適用",
    ...
    fr: {
      ...
      "landing.opt.bpm":       "BPM",
      "landing.opt.bpm_hint":  "vide = AI choisit",
      "landing.opt.style":     "STYLE",
      "landing.opt.style_hint":"vide = aucune contrainte",
      "landing.opt.custom":           "RÈGLES PERSO",
      "landing.opt.custom_placeholder":"ex: uniquement A:dorian / batterie seule / pad obligatoire...",
      "landing.opt.custom_hint":      "règles libres appliquées à chaque génération",
